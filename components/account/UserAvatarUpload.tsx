    ...
    <div className="flex flex-col sm:flex-row items-center gap-5">
      ...
      <div className="relative shrink-0">
        ...
        <button
          ...
          disabled={uploading}
          className="absolute bottom-0 right-0 w-8 h-8 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-md transition-colors disabled:opacity-50"
        >
      ...
      <div
        ...
        className={`flex-1 border-2 border-dashed rounded-2xl p-5 text-center transition-colors ${dragging ? 'border-green-400 bg-green-50' : 'border-gray-200 hover:border-green-300 hover:bg-green-50/30'} ${uploading ? 'opacity-60 pointer-events-none' : ''}`}
      >
