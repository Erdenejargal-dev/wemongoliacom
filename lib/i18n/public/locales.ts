...
const mn: PublicTranslations = {
  ...
  switcher: {
    ...
    footnote:
      'Сонгосон үнэ валютаар харагдах ба төлбөр үндсэн валютаар хийгдэнэ.',
  },
  tourCard: {
    perPerson:         '/ хүн',
    selectDeparture:   'Гарах өдөр сонгох',
    noDepartures:
      'Удахгүй гарах зочид алга. Тухайн үйлчилгээ үзүүлэгчтэй холбогдоно уу.',
    guests:            'Зочин',
    guestsOne:         '1 зочин',
    guestsMany:        'зочин',
    seatsRemaining:    (n) => `${n} суудал үлдсэн`,
    sellingFast:       'Эрэлттэй байна',
    sellingOut:        'Дуусах дөхөж байна',
    maxGuests:         (n) => `Нэг удаад дээд тал нь ${n} зочин`,
    reserveCta:        'Захиалах',
    noDepartureSelected: 'Гарах өдөр сонгоно уу',
    notAvailableCta:   'Гарах өдөр сонгоогүй байна',
  ...
  requestModal: {
    ...
    successLead:   'Бид тантай холбогдож баталгаажуулах ба төлбөрийн нөхцлийг явуулах болно.',
    successBody:   (email) =>
      `Ихэвчлэн 1 ажлын өдрийн дотор хариу өгдөг. Баримт ${email} хаяг руу очно.`,
    done:          'Амжилттай',
    nameLabel:     'Таны нэр',
    emailLabel:    'Имэйл',
    phoneLabel:    'Утас (сонголтоор)',
    messageLabel:  'Хүсэлт (сонголтоор)',
  ...
  capability: {
    unpayableMnTitle:
      'Энэ жагсаалтыг онлайнаар төлөх боломжгүй байна',
    unpayableDescription: (cur) =>
