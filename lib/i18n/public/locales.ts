...
const mn: PublicTranslations = {
  ...
  switcher: {
    ...
    footnote:
      'Үнэ сонгосон валютаар харагдах ба төлбөр үндсэн валютаар хийгдэнэ.',
  },
  tourCard: {
    perPerson:         '/ хүн',
    ...
    notAvailableCta:   'Хөдлөх өдөр сонгоогүй байна',
  ...
  requestModal: {
    ...
    successLead:   'Бид тантай холбогдож баталгаажуулах ба төлбөрийн нөхцлийг тохируулах болно.',
    successBody:   (email) =>
