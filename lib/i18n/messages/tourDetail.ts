...
export const tourDetailMn: TourDetailMessages = {
  ...
  sectionHighlights: 'Онцлох зүйлс',
  highlightsPlaceholder: 'Аяллын зохион байгуулагч тун удахгүй онцлох зүйлсээ оруулна.',
  sectionItinerary: 'Өдөр бүрийн төлөвлөгөө',
  itineraryEmpty: 'Төлөвлөгөө ороогүй байна.',
  ...
  reviewsPlaceholder: 'Сэтгэгдэл одоогоор алга.',
  contactCardTitle: 'Асуулт байна уу?',
  contactCardWithProvider: (name) =>
    `${name}-ээс асуулт асуух — ихэвчлэн хэдэн цагийн дотор хариу бичих болно.`,
  contactCardGeneric: 'Ихэвчлэн хэдэн цагийн дотор хариу бичих болно.',
  contactCtaButton: 'Мессеж бичих',
  infoDuration: 'Үргэлжлэх хугацаа',
  infoGroupSize: 'Аялагчдын тоо',
  infoExperience: 'Төрөл',
  infoDifficulty: 'Аялаын түвшин',
  infoLanguage: 'Хэл',
