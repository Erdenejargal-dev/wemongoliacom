...
export const authMn: AuthMessages = {
  traveler: {
    ...
    subtitle:         'Өргөөндөө нэвтрэн, Монголын жинхэнэ аяллын сонголтоо бүртгүүлээрэй.',
    ...
    panelHeading:     'Жинхэнэ Монголыг нээнэ үү',
    panelSubtitle:
      'Нутгийн төрөлжсөн мэргэжилтнүүдтэй холбогдон, тусгай аяллын сонголт бүртгээрэй.',
    trustItems: [
      'Монголын нутгийн төрөлжсөн түншлүүдийн аялал',
      'Найдвартай туршлага, аюулгүй захиалга',
      'Адал явдалд тэмүүлэгчдийн нэгдэлд нэгдээрэй',
    ],
