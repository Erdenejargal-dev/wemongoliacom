...
export const authMn: AuthMessages = {
  traveler: {
    ...
    subtitle:         'Нэвтэрж орон, Монгол орноор аялах сонголтоо бүтээгээрэй.',
    ...
    panelHeading:     'Эрх чөлөөг мэдрээрэй',
    panelSubtitle:
      'Нутгийн мэргэжилтнүүдтэй холбогдон, тусгай аяллын сонголтоо бүтээгээрэй.',
    trustItems: [
      'Монголын нутгийн төрөлжсөн түншлүүдийн аялал',
      'Найдвартай байдал, баталгаатай захиалга',
      'Адал явдалд хайгчидийн цугларах газар',
    ],
    legalBeforeTerms: 'Үргэлжлүүлэх ',
  ...
  host: {
    ...
    subtitle:         'Үйлчилгээ эрхлэгчээр нэвтэрнэ үү',
    emailLabel:       'Имэйл хаяг',
    emailPlaceholder: 'you@example.com',
    passwordLabel:    'Нууц үг',
    ...
    trustItems: [
      'Бизнесээ хялбараар бүртгэж, удирдах боломж',
