...
export const registerAccountMn: RegisterAccountMessages = {
  traveler: {
    ...
    panelSubtitle:
      'Өргөн уудам Говьгоос Хөвсгөлийн эрэг хүртэл — энэ нутагт таныг холбосон туршлагуудыг олно.',
    trustItems: [
      'Монголын хамгийн онцлог чиглэлүүдийг нээнэ үү',
      'Аюулгүй төлбөртэйгөөр итгэлтэй захиална',
      'Нутгийн гид, нийгмийг дэмжинэ',
    ],
