...
export const browseMn: BrowseMessages = {
  stays: {
    ...
    heroLead:
      'Уламжлалт гэр ба зочид буудлаас тансаг амралт хүртэл бүх сонголтууд бүгд нэг дор',
    searchPlaceholder: 'Нэр эсвэл чиглэлээр хайх…',
    from: 'Үндсэн үнэ',
    perNight: ' / шөнө',
    priceOnRequest: 'Үнийн санал',
    viewCta: 'Үзэх',
    types: {
      all: 'Бүгд',
      ger_camp: 'Гэр буудал',
      ...
      resort: 'Амралт',
      lodge: 'Лодж',
      guesthouse:'Дэн буудал',
      homestay: 'Айлд байрлах',
    },
  ...
  destinations: {
    ...
    ctaTitle: 'Адал явдлаа эхлүүлэхэд бэлэн үү?',
    ctaLead: 'Монгол даяарх аялал, буудал — байршил гээд бүгд нэг дор.',
    ctaTours: 'Аяллууд үзэх',
    ctaStays: 'Амралт, буудал',
    heroImageAlt: 'Чиглэл, газар',
  },
  travel: {
    whereLabel: 'Хаашаа',
    placeholderWhere: 'Аялахаар зорьсон газар',
    checkIn: 'Ирэх',
    checkOut: 'Гарах',
    search: 'Хайх',
  ...
  checkout: {
    ...
    subtitle: 'Энэ захиалгын үндсэн зочин',
    fullName: 'Бүтэн нэр',
    email: 'Имэйл',
    phone: 'Утас',
    country: 'Улс',
    ...
    placeholderName: 'Пасспорт дээрхтэй ижил',
    placeholderEmail: 'you@example.com',
    placeholderPhone: '+976 9900 0000',
    placeholderSpecial: 'Хоолны дэглэм, нэвтрэх тусламж, бусад хүсэлт…',
    consentBefore: 'Захиалга баталгаажуулахаас өмнө',
    terms: 'Үйлчилгээний нөхцөл',
    consentBetween: 'болон',
    privacy: 'Нууцлалын бодлогыг',
    consentAfter: ' зөвшөөрнө. Аялагчийн мэдээллийг зөвхөн захиалгад ашиглана.',
  },
  detail: {
