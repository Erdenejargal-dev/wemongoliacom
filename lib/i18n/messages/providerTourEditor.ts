...
const categoriesMn: Record<string, string> = {
  ...
  Cultural: 'Соёл',
  'Wildlife & Nature': 'Зэрлэг ан амьтан, байгаль',
  Photography: 'Гэрэл зураг',
  'Trekking & Hiking': 'Явган аялал',
  'Horseback Riding': 'Морь унах',
  Luxury: 'Дээд зэрэглэл',
  Budget: 'Хэмнэлттэй',
  Family: 'Гэр бүл',
  Festival: 'Наадам, арга хэмжээ',
  'Nomadic Life': 'Нүүдэлчдийн амьдрал',
  Other: 'Бусад',
}
...
export const providerTourEditorMn: ProviderTourEditorMessages = {
  ...
  readinessMissing: {
    ...
    oneDeparture: 'Дор хаяж 1 аялал (departure) шаардлагатай',
  },
  departures: {
    hintPublish: 'Нийтлэхэд дор хаяж нэг аялал (departure) шаардлагатай.',
  ...
  sections: {
    photos: 'Зураг',
    photosDesc: (count) => `${count} оруулсан — нийтлэхэд дор хаяж 1+ шаардлагатай`,
    basicInfo: 'Үндсэн мэдээлэл',
    basicInfoDesc: 'Гарчиг, тайлбар — аялагчдын жагсаалт, дэлгэрэнгүй хуудсанд харагдана.',
  ...
  labels: {
    ...
    currency: 'Валют',
    cancellation: 'Цуцлалтын шаардлага',
  },
  placeholders: {
    shortDesc: 'Нэг мөрт хайлтад, картан дээр гарч ирнэ…',
    fullDesc: 'Энэ аялалын онцлог, үзэсгэлэн, соёл, багтсан зүйлс…',
    duration: 'жш. 3',
    maxGuests: 'жш. 12',
    minGuests: 'жш. 2',
    languages: 'жш. English, Mongolian, Chinese',
    meetingPoint: 'жш. Чингис хаан олон улсын нисэх, эсвэл зочид буудлын лобби (Улаанбаатар)',
    cancellation: 'жш. Аялалаас 14 хоногоос өмнө төлдбөрийг бүрэн буцаан олгоно. 14 хоног дотор 50%…',
  },
  hints: {
    ...
    maxGroup: 'Аялал бүрийн дээд тооны зочин.',
    minGroup: 'Аялал хөдлөх доод хүний хэмжээ. Хоосон бол дурын тоо зөвшөөрнө.',
  ...
  status: {
    ...
    paused: 'Зогсоосон',
    pausedDesc: 'Түр нууцалсан. Одоо байгаа захиалгад нөлөөгүй.',
