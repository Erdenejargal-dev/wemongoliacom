...
export const mn: AdminTranslations = {
  ...
  overview: {
    ...
    quickActions: {
      ...
      users:     { label: 'Хэрэглэгчийн булан',          desc: 'Хэрэглэгчдийн эрхийг харах, засах' },
      providers: { label: 'Бизнес эрхлэгчийн булан', desc: 'Бизнесийг баталгаажуулах, хянах' },
      bookings:  { label: 'Захиалга удирдах',            desc: 'Захиалгыг хянах, дэмжлэг үзүүлэх' },
      pricingHealth: { label: 'Үнийн хэмжүүр', desc: ' сүүлийн мэдээлэл, backfill, хүлээгдэж буй захиалга' },
    },
    revenueNotes: {
      mixedCurrenciesMnt: 'тухайн валютын ханшаар MNT руу шилжүүлсэн нийт.',
      fxUnavailable: 'FX ханш байхгүй — валютаар нь нийт гаргасан.',
    },
    errorLoadingDashboard: 'Хэрэглэгчийн самбарын мэдээлэл уншиж чадсангүй.',
  },
  ...
  users: {
    ...
    errorLoading: 'Хэрэглэгчид олдсонгүй.',
  },
  ...
  providers: {
    ...
    detail: {
      owner:               'Бизнес эрхлэгч',
      contact:             'Холбоо барих',
      about:               'Үйл ажиллагааны тухай',
      location:            'Байршил',
      ...
      bookings:            'Захиалгууд',
      reviews:             'Үнэлгээнүүд',
      rejectionReasonBadge: 'Татгалзсан шалтгаан',
      rejectionReasonLabel: 'Татгалзсан шалтгаан',
      rejectionPlaceholder:
        'Яагаад энэ эрхлэгчийг татгалзаж буйгаа тайлбарлана уу. Энэ мэдэгдлийг имэйлээр тэдэнд явуулна.',
    ...
    actions: {
      ...
      revokeVerification: 'Баталгаажуулалт уцлах',
      confirmRejection:   'Түдгэлзэлт зөвшөөрөх',
    },
