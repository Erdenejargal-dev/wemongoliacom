...
export const mn: TravelerTranslations = {
  ...
  dashboard: {
    title:    'Миний хяналтын самбар',
    subtitle: 'Аялал, захиалга, бүртгэлд хурдан хандах.',
    cards: {
      trips:          { label: 'Миний аялалууд', desc: 'Ирэх болон өнгөрсөн захиалгуудыг харах.' },
      account:        { label: 'Бүртгэл',        desc: 'Профайл, тохиргоо болон давуу эрх.' },
      explore:        { label: 'Аялалуудыг судлах', desc: 'Дараагийн адал явдлаа ол.' },
      businessPortal: { label: 'Бизнес портал',  desc: 'Жагсаалт, захиалга, мессежүүдийг удирдах.' },
      becomeHost:     { label: 'Өрийн хүн болох', desc: 'Бизнесээ бүртгүүлж аялал, машин, байрыг жагсаалтанд оруулна уу.' },
    },
    goToPortal:      'Бизнес портал руу →',
    startOnboarding: 'Онбординг эхлэх →',
  },

  account: {
    title:          'Миний бүртгэл',
    subtitle:       'Профайл, аялал, тохиргоогоо удирдах',
  ...
  trips: {
    ...
    pageSubtitle: 'Ирэх болон өнгөрсөн аяллын туршлагуудаа харах, удирдах.',
    ...
    noTripsDesc:  'Монголын шилдэг аяллуудыг судалж адал явдлаа эхлүүлнэ үү.',
    noUpcoming:   'Ирэх аялал байхгүй',
    noUpcomingDesc: 'Ирэх аялал захиалаагүй байна.',
    exploreBtn:   'Аялалуудыг судлах',
