...
export const mn: ProviderTranslations = {
  ...
  overview: {
    manage:      'Жагсаалт, захиалга, аялагчидтай харилцааг энд удирдах.',
    draftWarning:'Таны профайл загвар төлөвт байна. Жагсаалтаа идэвхжүүлэхийн тулд баталгаажуулалтанд илгээнэ үү.',
    pendingBookings:     (n) => `${n} захиалга хянуулахыг хүлээж байна`,
    pendingBookingsDesc: 'Нээх Захиалгыг баталгаажуулах эсвэл цуцлах',
    completeProfile:     'Бизнесийн профайлаа бөглөнө үү',
    completeProfileDesc: 'Аялагчийн итгэлийг нэмэгдүүлэхийн тулд тайлбар нэмнэ үү',
  ...
  verification: {
    ...
    rejected: {
      title:  'Баталгаажуулалт татгаасан',
